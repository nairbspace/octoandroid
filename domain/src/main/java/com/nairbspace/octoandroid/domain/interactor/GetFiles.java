...
public class GetFiles extends UseCase {

    private final PrinterRepository mPrinterRepository;

    @Inject
    public GetFiles(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread,
    ...
    protected Observable buildUseCaseObservable() {
        return mPrinterRepository.getAllFiles();
    }
}
