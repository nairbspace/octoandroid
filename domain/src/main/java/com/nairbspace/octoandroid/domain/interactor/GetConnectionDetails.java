...
public class GetConnectionDetails extends UseCase {

    private final PrinterRepository mPrinterRepository;

    @Inject
    public GetConnectionDetails(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread,
    ...
    protected Observable buildUseCaseObservable() {
        return mPrinterRepository.connectionDetails();
    }
}
