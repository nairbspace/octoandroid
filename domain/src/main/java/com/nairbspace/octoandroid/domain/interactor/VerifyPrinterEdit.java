...
public class VerifyPrinterEdit extends UseCase {

    private final PrinterRepository mPrinterRepository;

    @Inject
    public VerifyPrinterEdit(ThreadExecutor threadExecutor,
    ...
    protected Observable buildUseCaseObservable() {
        return mPrinterRepository.verifyPrinterDetailsEdit();
    }
}
