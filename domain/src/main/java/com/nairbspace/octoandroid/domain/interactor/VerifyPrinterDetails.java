...
public class VerifyPrinterDetails extends UseCase {

    private final PrinterRepository mPrinterRepository;

    @Inject
    public VerifyPrinterDetails(ThreadExecutor threadExecutor,
    ...
    protected Observable buildUseCaseObservable() {
        return mPrinterRepository.verifyPrinterDetails();
    }
}
