...
public class GetStickyNotificationSetting extends UseCase {

    private final PrinterRepository mPrinterRepository;

    @Inject
    public GetStickyNotificationSetting(ThreadExecutor threadExecutor,
    ...
    protected Observable buildUseCaseObservable() {
        return mPrinterRepository.isStickyNotificationOn();
    }
}
