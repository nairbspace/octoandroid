...
public class CheckIfDbIsEmpty extends UseCase {

    private final PrinterRepository mPrinterRepository;

    @Inject
    public CheckIfDbIsEmpty(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread,
    ...
    protected Observable buildUseCaseObservable() {
        return mPrinterRepository.isDbEmpty();
    }
}
