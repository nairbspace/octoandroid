...
import com.nairbspace.octoandroid.ui.files.FilesFragment.OnListFragmentInteractionListener;
...
public class FilesRecyclerViewAdapter extends RecyclerView.Adapter<FilesRecyclerViewAdapter.ViewHolder> {
    ...
    public FilesRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
